...
def post( url, postData ):
    curl     = get_value("urllib");
    postDataEncode = curl.parse.urlencode( postData ).encode( encoding="UTF8" );
    requestObj = curl.request.Request( url, data=postDataEncode, method="POST" );
    request = curl.request.urlopen( requestObj );
    return request;